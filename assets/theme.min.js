    ...
    var c = function () {
        ...
        k = function () {
            ...
            return i(t, [{
                ...
                value: function () {
                    ...
                    this.element.querySelectorAll(".Product__SlideItem--image").forEach((function (t) {
                        t.classList.contains("Product__SlideItem--image") && e.push(t.querySelector("img"));
                    })), this._createPhotoSwipeInstance(this._createPhotoSwipeItemsFromImages(e), parseInt(this.slideshow.flickityInstance.selectedElement.getAttribute("data-image-media-position")))
                }
            }, {
               ...
               key: "_createPhotoSwipeItemsFromImages",
                value: function (e) {
                    ...
                    return e.map((function (e) {
                        ...
                        // check if the image size is null or not
                        if (isNaN(t) || isNaN(i)) {
                            return null;
                        }
                    ...
                    })).filter(imageData => imageData !== null); // Filter out null entries
                }
            }, {
        ...
        T = function () {
            ...
            return i(t, [{
                ...
                key: "_updateSku",
                value: function (e) {
                  var t = document.querySelector(".ProductMeta__SkuNumber");
                    if (t && e) {
                ...
                value: function (e) {
                    var t = this.element.querySelector(".ProductForm__AddToCart"),
                        isPreOrder = t.classList.contains("preorder_atc"),
                        i = this.element.querySelector(".shopify-payment-button");
                        var atc_text = isPreOrder ? window.languages.productFormAddToCartPreorder : window.languages.productFormAddToCart;
                    t.classList.remove("Button--secondary"), t.classList.remove("Button--primary"), e ? e.available || isPreOrder ? (t.removeAttribute("disabled"), t.classList.add("true" === t.getAttribute("data-use-primary-button") ? "Button--primary" : "Button--secondary"), t.setAttribute("data-action", "add-to-cart"), void 0 === this.options.showPriceInButton || this.options.showPriceInButton ?  t.innerHTML = "\n            <span>".concat(atc_text, '</span>\n            <span class="Button__SeparatorDot"></span>\n            <span data-money-convertible>').concat(I.formatMoney(e.price, window.theme.moneyFormat), "</span>\n          ") : t.innerHTML = "<span>".concat(atc_text, "</span>")) : (t.setAttribute("disabled", "disabled"), t.classList.add("Button--secondary"), t.removeAttribute("data-action"), t.innerHTML = window.languages.productFormSoldOut) : (t.setAttribute("disabled", "disabled"), t.removeAttribute("data-action"), t.classList.add("Button--secondary"), t.innerHTML = window.languages.productFormUnavailable), this.options.showPaymentButton && i && (e && e.available ? i.style.display = "block" : i.style.display = "none")
                }
            }, {
            ...
            return i(t, [{
                ...
                value: function (e, t) {
                    ...
                    for (var i = 0; i !== this.productSlideshow.flickityInstance.cells.length; ++i) {
                        ...
                        parseInt(n.getAttribute("data-media-id")) === parseInt(t.getAttribute("data-media-id")) && this.productSlideshow.selectCell(parseInt(n.getAttribute("data-media-position")))
                    }
                }
            }, {
                key: "_checkQuickNav",
